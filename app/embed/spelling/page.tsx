...
/**
 * Embeddable spelling worksheet maker. Minimal chrome, one "powered by"
 * backlink. The headers() carve-out in next.config.ts makes /embed/* frameable
 * by any origin.
 */
export default function SpellingEmbedPage() {
  return (
    <div className="p-4 sm:p-6">
      ...
      <p className="mt-4 text-center text-xs text-gray-500">
        Free tool by{' '}
        <a
          href="https://anywherelearning.co/tools/spelling"
          target="_blank"
          rel="noopener"
