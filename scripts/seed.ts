...
async function seed() {
  ...
  const productData = [
    // === BUNDLES (sortOrder 1–5) ===
    {
      ...
      stripePriceId: 'price_1T84fYAMzOBftCntVUMK7fTY',
    ...
    },
    {
      ...
      stripePriceId: 'price_1T84fZAMzOBftCnta7rRlJOt',
    ...
    },
    {
      ...
      stripePriceId: 'price_1T84faAMzOBftCntqNrVTBL1',
    ...
    },
    {
      ...
      stripePriceId: 'price_1T84fbAMzOBftCntXPfMdQtJ',
    ...
    },
    {
      ...
      stripePriceId: 'price_1T84fcAMzOBftCntJGzmkNqm',
    ...
    // === SEASONAL (sortOrder 10–13) ===
    {
      ...
      stripePriceId: 'price_1T84fdAMzOBftCntA09R4cEL',
    ...
    },
    {
      ...
      priceCents: 1499,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84ffAMzOBftCnt53nZw0yA',
    ...
    },
    {
      ...
      priceCents: 1499,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fgAMzOBftCnt5pCM7IPk',
    ...
    },
    {
      ...
      priceCents: 1499,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fhAMzOBftCntLn2cSKXr',
    ...
    // === CREATIVITY (sortOrder 20–22) ===
    {
      ...
      priceCents: 1299,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fiAMzOBftCntlnvyR5l8',
    ...
    },
    {
      ...
      priceCents: 1299,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fjAMzOBftCntnvDbkfNt',
    ...
    },
    {
      ...
      priceCents: 1299,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fkAMzOBftCntDpXWjJM1',
    ...
    // === NATURE (sortOrder 30–32) ===
    {
      ...
      priceCents: 999,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84flAMzOBftCntvr63Kril',
    ...
    },
    {
      ...
      priceCents: 999,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fmAMzOBftCnt7fzMCFKh',
    ...
    },
    {
      ...
      priceCents: 999,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fnAMzOBftCntiEAzRIaL',
    ...
    // === REAL-WORLD SKILLS (sortOrder 40–43) ===
    {
      ...
      priceCents: 999,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84foAMzOBftCntM6b8MYOU',
    ...
    },
    {
      ...
      priceCents: 999,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fpAMzOBftCntoZElRBr2',
    ...
    },
    {
      ...
      priceCents: 999,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fqAMzOBftCntPsteiEGw',
    ...
    },
    {
      ...
      priceCents: 999,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84frAMzOBftCntHhNHe2Cd',
    ...
    // === LIFE SKILLS (sortOrder 50) ===
    {
      ...
      priceCents: 999,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fsAMzOBftCntpdGz3koB',
    ...
    // === AI LITERACY (sortOrder 60–61) ===
    {
      ...
      priceCents: 999,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84ftAMzOBftCntLIB4D3H4',
    ...
    },
    {
      ...
      priceCents: 999,
      compareAtPriceCents: null,
      stripePriceId: 'price_1T84fuAMzOBftCntiILQKAMW',
