...
async function seed() {
  ...
  const productData = [
    ...
    { name: 'Fall Outdoor Learning Pack', slug: 'fall-outdoor-pack', description: '20 autumn activities for observation and creative skills.', shortDescription: '20 fall outdoor activities.', priceCents: 1499, compareAtPriceCents: null, stripePriceId: 'price_1TFcTRAMzOBftCntOiiukmBd', blobUrl: '', category: 'outdoor-learning', isBundle: false, bundleProductIds: null, activityCount: 20, ageRange: 'Ages 6\u201314', sortOrder: 12, active: true },
    { name: 'Winter Outdoor Learning Pack', slug: 'winter-outdoor-pack', description: '20 winter activities for indoor and outdoor adventures.', shortDescription: '20 winter activities.', priceCents: 1499, compareAtPriceCents: null, stripePriceId: 'price_1TFcTSAMzOBftCntqOOGzx0P', blobUrl: '', category: 'outdoor-learning', isBundle: false, bundleProductIds: null, activityCount: 20, ageRange: 'Ages 6\u201314', sortOrder: 13, active: true },
