...
async function seed() {
  ...
  const productData = [
    ...
    },
    {
      ...
      description: 'All 10 Worldschooling guides in one download: cultural celebrations, currency math, language missions, food detective, transport navigation, and more.',
      shortDescription: 'All 10 Worldschooling guides in one download.',
      priceCents: 4499,
      compareAtPriceCents: 5999,
    ...
    { name: 'My Nature Journal', slug: 'nature-journal-walks', description: 'A guided nature journal with prompts for sketching, writing, and outdoor observation.', shortDescription: 'Guided nature journal for outdoor observation.', priceCents: 799, compareAtPriceCents: null, stripePriceId: 'price_1TFcTSAMzOBftCntNAM1nnp4', blobUrl: '', imageUrl: '/products/nature-journal-walks.jpg', category: 'outdoor-learning', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6\u201314', sortOrder: 20, active: true },
    ...
    // === WORLDSCHOOLING (sortOrder 200-209) ===
    { name: 'Cultural Celebration Journal', slug: 'cultural-celebration-journal', description: 'Document festivals, holidays, and cultural celebrations through guided observation and reflection.', shortDescription: 'Document cultural celebrations through observation.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TS08fAkIBECpwGmmkgwZ26F', blobUrl: '', imageUrl: '/products/cultural-celebration-journal.jpg', category: 'worldschooling', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 200, active: true },
    { name: 'Currency & Market Math', slug: 'currency-market-math', description: 'Convert currencies, compare prices, and practise mental maths in real markets.', shortDescription: 'Currency and market maths in real markets.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TS08fAkIBECpwGmwUsCteF2', blobUrl: '', imageUrl: '/products/currency-market-math.jpg', category: 'worldschooling', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 201, active: true },
    { name: 'Everyday Life Comparison', slug: 'everyday-life-comparison', description: 'Compare daily life across cultures: transport, food, school, and play.', shortDescription: 'Compare everyday life across cultures.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TS08gAkIBECpwGmg1RJabLC', blobUrl: '', imageUrl: '/products/everyday-life-comparison.jpg', category: 'worldschooling', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 202, active: true },
    { name: 'Local Language Mission', slug: 'local-language-mission', description: 'Build confidence in a new language through real-world missions and challenges.', shortDescription: 'Real-world language missions.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TS08gAkIBECpwGmAQk4fwgK', blobUrl: '', imageUrl: '/products/local-language-mission.jpg', category: 'worldschooling', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 203, active: true },
    { name: 'Nature & Geography Field Study', slug: 'nature-geography-field-study', description: 'Observe local plants, wildlife, climate, and geography wherever you travel.', shortDescription: 'Field study of nature and geography.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TS08hAkIBECpwGmAdyMW1AM', blobUrl: '', imageUrl: '/products/nature-geography-field-study.jpg', category: 'worldschooling', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 204, active: true },
    { name: 'People & Stories Interview Project', slug: 'people-stories-interview', description: 'Interview locals and travellers, listen carefully, and record their stories.', shortDescription: 'Interview people and collect stories.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TS08iAkIBECpwGmwqkBXDHr', blobUrl: '', imageUrl: '/products/people-stories-interview.jpg', category: 'worldschooling', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 205, active: true },
    { name: 'Street Explorer Map Maker', slug: 'street-explorer-map-maker', description: 'Walk new neighbourhoods and create hand-drawn maps with landmarks and stories.', shortDescription: 'Hand-drawn maps of new neighbourhoods.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TS08iAkIBECpwGmS2qJguOh', blobUrl: '', imageUrl: '/products/street-explorer-map-maker.jpg', category: 'worldschooling', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 206, active: true },
    { name: 'Transport & Navigation Challenge', slug: 'transport-navigation-challenge', description: 'Read maps, decode local transport, and plan real routes in unfamiliar places.', shortDescription: 'Navigate transport in new places.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TS08jAkIBECpwGmI2C7uWqZ', blobUrl: '', imageUrl: '/products/transport-navigation-challenge.jpg', category: 'worldschooling', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 207, active: true },
    { name: 'Travel Reflection & Postcards', slug: 'travel-reflection-postcards', description: 'Capture travel memories through hand-made postcards and reflective writing.', shortDescription: 'Hand-made postcards and travel reflection.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TS08jAkIBECpwGmq10DEOLG', blobUrl: '', imageUrl: '/products/travel-reflection-postcards.jpg', category: 'worldschooling', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 208, active: true },
    ...
    // === EMOTIONAL & SOCIAL SKILLS (sortOrder 220-231) ===
    { name: 'The Calm-Down Toolkit', slug: 'calm-down-toolkit', description: 'Build a real reset kit and a when-I\'m-flooded plan from household stuff. Test tools that actually settle the body.', shortDescription: 'Build a real calm-down toolkit and reset plan.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZpeAkIBECpwGmsTn643dE', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Calm-Down%20Toolkit.pdf', imageUrl: '/products/calm-down-toolkit.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 220, active: true },
    { name: 'The Big Feelings Lab', slug: 'big-feelings-lab', description: 'Name a feeling, find where it sits in the body, rate its size, and watch it pass. Build a personal feelings map.', shortDescription: 'Name big feelings and map them in the body.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZpfAkIBECpwGmOwJg9l88', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Big%20Feelings%20Lab.pdf', imageUrl: '/products/big-feelings-lab.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 221, active: true },
    { name: 'The Boredom Toolkit', slug: 'boredom-toolkit', description: 'Build the skill of handling boredom without a screen. Real toolkit, a no-screens stretch, and a log of what they made.', shortDescription: 'Help kids handle boredom without a screen.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZpfAkIBECpwGm3oxNsgji', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Boredom%20Toolkit.pdf', imageUrl: '/products/boredom-toolkit.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 222, active: true },
    { name: 'The Disappointment Lab', slug: 'disappointment-lab', description: 'Sit through a small planned letdown, name the feeling, and track how long it takes to bounce back.', shortDescription: 'Build resilience by tracking recovery time.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZpgAkIBECpwGmdBefEIXn', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Disappointment%20Lab.pdf', imageUrl: '/products/disappointment-lab.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 223, active: true },
    { name: 'The Comeback Journal', slug: 'comeback-journal', description: 'Take a real flop, break it down without spiraling, pull out the lesson, pick the next move. Build a comeback journal habit.', shortDescription: 'Process real flops and pick the next move.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZphAkIBECpwGmkbMH03LR', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Comeback%20Journal.pdf', imageUrl: '/products/comeback-journal.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 9–14', sortOrder: 224, active: true },
    { name: 'The Hard Thing Challenge', slug: 'hard-thing-challenge', description: 'Pick one genuinely hard thing, commit to it for a stretch, log the messy middle, and cross the finish.', shortDescription: 'Pick a hard thing and finish it.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZphAkIBECpwGmehQbYZr2', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Hard%20Thing%20Challenge.pdf', imageUrl: '/products/hard-thing-challenge.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 225, active: true },
    { name: 'The Repair Conversation', slug: 'repair-conversation', description: 'Practise what to do after hurting someone: own it, skip excuses, ask what would help, follow through.', shortDescription: 'Own a mistake and repair the relationship.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZpiAkIBECpwGmg1Xu67b3', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Repair%20Conversation.pdf', imageUrl: '/products/repair-conversation.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 226, active: true },
    { name: 'The Kindness Missions', slug: 'kindness-missions', description: 'Build and work through a deck of real-world kindness challenges that take effort and noticing.', shortDescription: 'A deck of real-world kindness missions.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZpiAkIBECpwGmna3K79c3', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Kindness%20Missions.pdf', imageUrl: '/products/kindness-missions.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 227, active: true },
    { name: 'Reading the Room', slug: 'reading-the-room', description: 'Practise noticing what others feel before words. Scan a room, read body language, infer the backstory.', shortDescription: 'Read body language and scan a room.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZpjAkIBECpwGmj3tD6ezs', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20Reading%20the%20Room.pdf', imageUrl: '/products/reading-the-room.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 9–14', sortOrder: 228, active: true },
    { name: 'The Conflict Fix', slug: 'conflict-fix', description: 'A real script for fights with siblings or friends: cool down, say it without attacking, hear the other side, find the fix.', shortDescription: 'A real script for conflict resolution.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZpjAkIBECpwGmhgx7Rtab', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Conflict%20Fix.pdf', imageUrl: '/products/conflict-fix.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 229, active: true },
    { name: 'The Solo Mission', slug: 'solo-mission', description: 'Take on age-right do-it-without-me challenges: order at a counter, call a place, run an errand.', shortDescription: 'Solo missions in the real world.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZpkAkIBECpwGmxbgBC5hB', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Solo%20Mission.pdf', imageUrl: '/products/solo-mission.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 230, active: true },
    { name: 'The Worry Sorter', slug: 'worry-sorter', description: 'Sort spinning worries into can-control vs cannot-control. Plan the controllable, practise letting go of the rest.', shortDescription: 'Sort worries and plan the controllable.', priceCents: 599, compareAtPriceCents: null, stripePriceId: 'price_1TdZpkAkIBECpwGmGO1cFkPF', blobUrl: 'https://xkj3tzlgu6ylgllk.public.blob.vercel-storage.com/Emotional%20%26%20Social%20Skills%20-%20The%20Worry%20Sorter.pdf', imageUrl: '/products/worry-sorter.jpg', category: 'emotional-social-skills', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6–14', sortOrder: 231, active: true },

    // === START HERE (sortOrder 90) ===
    { name: 'The Future-Ready Skills Map', slug: 'future-ready-skills-map', description: 'A 44-page parent guide to the 12 skill areas that matter most for kids ages 0-16+, organised into three age phases (Play, Build, Apply).', shortDescription: '44-page parent guide: 12 future-ready skill areas, ages 0-16+.', priceCents: 999, compareAtPriceCents: null, stripePriceId: 'price_1T9JSZAMzOBftCntfh73EgWC', blobUrl: '', imageUrl: '/products/future-ready-skills-map.jpg', category: 'start-here', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 0\u201316+', sortOrder: 90, active: true },

    // === FREE-GUIDE FULL VERSIONS (membership-only, stripePriceId '') ===
    { name: 'Square Foot Safari', slug: 'square-foot-safari', description: 'Mark off one small square of ground and study it like a field scientist: observe, dig into the layers, keep field notes, and return across seasons.', shortDescription: 'Outdoor STEM science: study one square of ground like a field scientist.', priceCents: 599, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', imageUrl: '/products/square-foot-safari.jpg', category: 'outdoor-learning', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6\u201314', sortOrder: 27, active: true },
    { name: 'The $20 Snack Mission', slug: 'snack-mission', description: 'A real budget, a real store, and real trade-offs. Your child plans, tracks a running total, makes choices, and counts the change.', shortDescription: 'Real-world STEM maths: a real budget, a real store, real trade-offs.', priceCents: 599, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', imageUrl: '/products/snack-mission.jpg', category: 'real-world-math', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6\u201314', sortOrder: 113, active: true },
    { name: 'Household Orchestra', slug: 'household-orchestra', description: 'Build a piece of music from five random household objects. Explore sounds, build a rhythm, shape a piece, and perform it.', shortDescription: 'Creativity: turn five household objects into real music.', priceCents: 599, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', imageUrl: '/products/household-orchestra.jpg', category: 'creativity-maker', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6\u201314', sortOrder: 41, active: true },
    { name: 'Three AIs, One Question', slug: 'three-ais-one-question', description: 'Ask the same question to three AI tools, compare the answers, and figure out where the AI is bluffing. Done together at the keyboard.', shortDescription: 'AI literacy: ask three AIs one question and catch the bluff.', priceCents: 599, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', imageUrl: '/products/three-ais-one-question.jpg', category: 'ai-literacy', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 9\u201314', sortOrder: 81, active: true },
    { name: 'Complaint to Product', slug: 'complaint-to-product', description: 'Turn an everyday family annoyance into a real product idea: collect complaints, pick one, invent a fix, design it, and pitch it.', shortDescription: 'Entrepreneurship: turn an annoyance into a real product idea.', priceCents: 599, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', imageUrl: '/products/complaint-to-product.jpg', category: 'entrepreneurship', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 8\u201314', sortOrder: 131, active: true },
    { name: 'The Two-Minute Story', slug: 'two-minute-story', description: 'Take a real moment from life and learn to tell it as a clear, gripping story in two minutes. Find the shape, cut it down, and tell it for real.', shortDescription: 'Communication: turn a real moment into a gripping two-minute story.', priceCents: 599, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', imageUrl: '/products/two-minute-story.jpg', category: 'communication-writing', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6\u201314', sortOrder: 121, active: true },
    { name: 'Plan a Mini Adventure', slug: 'plan-a-mini-adventure', description: 'Plan a real two-hour family outing from start to finish, then lead the day. Choose it, work out the details, make the plan, and look back.', shortDescription: 'Planning: plan and lead a real two-hour family outing.', priceCents: 599, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', imageUrl: '/products/plan-a-mini-adventure.jpg', category: 'planning-problem-solving', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6\u201314', sortOrder: 144, active: true },
  ];
