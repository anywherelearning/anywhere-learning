...
async function seed() {
  ...
  const productData = [
    ...
    { name: 'Community Impact Project', slug: 'community-impact', description: 'Plan and run a project that helps your local community.', shortDescription: 'Community impact project.', priceCents: 499, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', category: 'literacy', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6\u201314', sortOrder: 52, active: true },
    ...
    { name: 'Media & Info Check', slug: 'media-info-check', description: 'Spot misinformation and think critically about media.', shortDescription: 'Media literacy and fact-checking.', priceCents: 499, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', category: 'critical-thinking', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 8\u201314', sortOrder: 54, active: true },
    { name: 'Micro-Business Challenge', slug: 'micro-business', description: 'Plan, launch, and run a simple real business.', shortDescription: 'Launch a micro-business.', priceCents: 499, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', category: 'critical-thinking', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 9\u201314', sortOrder: 55, active: true },
    { name: 'Problem-Solver Studio', slug: 'problem-solver', description: 'Structured approach to solving real-world problems.', shortDescription: 'Real-world problem solving.', priceCents: 499, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', category: 'critical-thinking', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6\u201314', sortOrder: 56, active: true },
    ...
    { name: 'Time & Energy Planner', slug: 'time-energy-planner', description: 'Build time management and energy awareness skills.', shortDescription: 'Time and energy management.', priceCents: 499, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', category: 'self-management', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 8\u201314', sortOrder: 58, active: true },
    { name: 'Travel Day Itinerary Challenge', slug: 'travel-day', description: 'Plan a full travel day \u2014 routes, budgets, timing.', shortDescription: 'Plan a travel day itinerary.', priceCents: 499, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', category: 'critical-thinking', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 6\u201314', sortOrder: 59, active: true },
    { name: 'Write It Like a Pro', slug: 'write-like-a-pro', description: 'Real-world writing for real audiences.', shortDescription: 'Real-world writing skills.', priceCents: 499, compareAtPriceCents: null, stripePriceId: '', blobUrl: '', category: 'literacy', isBundle: false, bundleProductIds: null, activityCount: null, ageRange: 'Ages 8\u201314', sortOrder: 60, active: true },
