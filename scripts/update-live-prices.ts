...
const livePrices: Record<string, string> = {
  "seasonal-bundle": "price_1TLrpcAkIBECpwGmAyxFqtdQ",
  "creativity-mega-bundle": "price_1TLrpcAkIBECpwGm1gWRuR2U",
  "real-world-mega-bundle": "price_1TLrpdAkIBECpwGmKbmfblVT",
  "ai-digital-bundle": "price_1TLrpdAkIBECpwGmWOMuCrfz",
  "real-world-math-bundle": "price_1TLrpeAkIBECpwGmhbXAOhRg",
  "communication-writing-bundle": "price_1TLrpeAkIBECpwGmVnKQMpKA",
  "entrepreneurship-bundle": "price_1TLrpfAkIBECpwGmA0PaKPRq",
  "planning-problem-solving-bundle": "price_1TLrpfAkIBECpwGm2c2aOLqz",
  "nature-art-bundle": "price_1TLrpfAkIBECpwGmRPLN4qJU",
  "outdoor-toolkit-bundle": "price_1TLrpgAkIBECpwGmR4OZB8Re",
  "outdoor-mega-bundle": "price_1TLrpgAkIBECpwGmoqnkOOr5",
  "spring-outdoor-pack": "price_1TLrphAkIBECpwGmz54p8cdF",
  "summer-outdoor-pack": "price_1TLrphAkIBECpwGmhWfOjp7H",
  "fall-outdoor-pack": "price_1TLrpiAkIBECpwGm1OhNYpir",
  "winter-outdoor-pack": "price_1TLrpiAkIBECpwGmfSg8PaaX",
  "nature-journal": "price_1TLrpjAkIBECpwGmzKYwKnSF",
  "nature-walk-cards": "price_1TLrpjAkIBECpwGmJyJr1nLx",
  "nature-choice-boards": "price_1TLrpkAkIBECpwGmyIH4cIoq",
  "outdoor-missions": "price_1TLrpkAkIBECpwGmTwx4qOin",
  "outdoor-stem-cards": "price_1TLrpkAkIBECpwGmu5xAWiJn",
  "land-art-challenge": "price_1TLrplAkIBECpwGmOiqnWNq2",
  "nature-crafts": "price_1TLrplAkIBECpwGmDRHFLmOW",
  "board-game-studio": "price_1TLrplAkIBECpwGmqLuaqfrp",
  "rube-goldberg": "price_1TLrplAkIBECpwGmkAIfCHjf",
  "survival-base": "price_1TLrplAkIBECpwGmkwPLN1cC",
  "imaginary-world": "price_1TLrplAkIBECpwGmhB3FZjNy",
  "creature-habitat": "price_1TLrplAkIBECpwGmPLXLb6j3",
  "theme-park": "price_1TLrplAkIBECpwGmZ4qrCIJB",
...
async function main() {
  let updated = 0;
  for (const [slug, priceId] of Object.entries(livePrices)) {
    await db.update(products)
      .set({ stripePriceId: priceId })
      .where(eq(products.slug, slug));
    updated++;
  }
  console.log(`Updated ${updated} products with live Stripe price IDs`);

  const remaining = await db.select({ slug: products.slug, stripePriceId: products.stripePriceId })
    .from(products);
  const testIds = remaining.filter(r => r.stripePriceId?.includes('AMzOBftCnt'));
  if (testIds.length > 0) {
    console.error(`WARNING: ${testIds.length} products still have test price IDs:`);
    testIds.forEach(r => console.error(`  ${r.slug}: ${r.stripePriceId}`));
  } else {
    console.log('✓ All products now have live Stripe price IDs');
  }
  process.exit(0);
}
main();
