...
// Tiers: Singles $4.99 · Nature cards $6.99 · Seasonal $12.99 · Guide $9.99
const catalog = [
  // ─── Bundles ───
  { slug: 'seasonal-bundle', name: 'Full Seasonal Bundle (All 4 Seasons)', priceCents: 3999, description: 'All 4 seasonal packs — 80 outdoor activities for every time of year.' },
  ...
  // ─── Seasonal ($12.99) ───
  { slug: 'spring-outdoor-pack', name: 'Spring Outdoor Learning Pack', priceCents: 1299, description: '20 outdoor activities that use spring\'s energy to build real-world skills.' },
  { slug: 'summer-outdoor-pack', name: 'Summer Outdoor Learning Pack', priceCents: 1299, description: '20 summer activities for families who learn on the move.' },
  { slug: 'fall-outdoor-pack', name: 'Fall Outdoor Learning Pack', priceCents: 1299, description: '20 autumn activities for observation, science, and creative skills.' },
  { slug: 'winter-outdoor-pack', name: 'Winter Outdoor Learning Pack', priceCents: 1299, description: '20 winter activities for cosy indoor days and cold outdoor adventures.' },
  // ─── Nature cards ($6.99) ───
  { slug: 'nature-journal-walks', name: 'Nature Journal & Walk Cards', priceCents: 699, description: '25 nature walk prompts and journaling activities.' },
  { slug: 'nature-walk-task-cards', name: 'Nature Walk Task Cards', priceCents: 699, description: 'Structured observation prompts for any outdoor walk.' },
  { slug: 'nature-choice-boards', name: 'Nature Choice Boards', priceCents: 699, description: 'Pick-your-own-adventure style nature activity boards.' },
  { slug: 'outdoor-learning-missions', name: 'Outdoor Learning Missions', priceCents: 699, description: 'Mission-based outdoor challenges for curious explorers.' },
  { slug: 'outdoor-stem-challenges', name: 'Outdoor STEM Challenge Cards', priceCents: 699, description: '20 outdoor STEM challenges in the natural world.' },
  { slug: 'land-art-challenges', name: 'Land Art Challenge Cards', priceCents: 699, description: '15 land art challenges using natural materials.' },
  { slug: 'nature-crafts', name: 'Nature Crafts for Kids', priceCents: 699, description: 'Hands-on crafting projects using natural materials.' },
