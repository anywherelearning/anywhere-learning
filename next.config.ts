...
const securityHeaders = [
  ...
  // Content Security Policy — allow our own content + trusted third parties
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://img.clerk.com https://*.public.blob.vercel-storage.com https://*.stripe.com",
      "frame-src https://js.stripe.com https://*.clerk.accounts.dev https://challenges.cloudflare.com",
      "connect-src 'self' https://*.stripe.com https://*.clerk.accounts.dev https://*.clerk.com https://*.upstash.io",
