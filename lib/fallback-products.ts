...
export const fallbackProducts: FallbackProduct[] = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    description:
      "All 12 Communication & Writing guides in one download — adventure storytelling, debate, interviews, recipe writing, magazine creation, trail guides, and more. Every activity puts kids in real communication scenarios where they write, speak, and present for real audiences.",
    shortDescription:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    description:
      "All 11 Entrepreneurship guides in one download — brand building, customer discovery, pitching, pricing, marketing, supply chains, and more. Real business skills through hands-on projects, not textbook exercises.",
    shortDescription:
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    description:
      "All 13 Planning & Problem-Solving guides in one download — survival planning, emergency prep, decision-making, scavenger hunts, everyday redesign, and more. Kids practise thinking ahead, solving real problems, and making smart decisions.",
    shortDescription:
