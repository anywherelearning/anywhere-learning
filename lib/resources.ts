...
const resources: ResourcePage[] = [
  {
    ...
    content: [
      ...
      {
        type: 'paragraph',
        text: 'You don\'t need to overhaul your homeschool to start real-world learning. Pick one area — money, cooking, navigation, writing — and find one real-world opportunity this week. Let your child lead. Ask questions instead of giving instructions. Celebrate the process, not just the outcome.',
      },
      {
        type: 'list',
        ordered: true,
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'paragraph',
        text: 'The biggest challenge with nature journaling isn\'t starting — it\'s maintaining the habit. Here\'s what\'s worked for our family: keep the journal by the door so you grab it on the way out. Set a low bar — even a one-minute sketch counts. Journal alongside your child (modeling matters more than instruction). And never, ever critique the drawing. The moment journaling becomes about artistic quality, kids stop doing it.',
      },
      {
        type: 'paragraph',
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'paragraph',
        text: 'Every child is a maker. Before we teach them to stop — "Don\'t make a mess," "Follow the instructions," "Color inside the lines" — kids naturally build, invent, and create. Maker activities bring that instinct back and channel it into powerful learning.',
      },
      {
        type: 'paragraph',
      ...
      {
        type: 'paragraph',
        text: 'Now kids can take on multi-step projects that span days or weeks. Design and sew a simple garment. Build a working catapult. Create a stop-motion animation. Write and illustrate a graphic novel. Program a simple video game. At this age, kids can also start solving real problems — designing a better organization system for their room, building a birdhouse from a plan, or creating a family recipe book.',
      },
      {
        type: 'heading',
        level: 3,
      ...
      },
      {
        ...
        items: [
          ...
          'Scissors (good ones — dull scissors kill motivation faster than anything)',
      ...
      {
        type: 'paragraph',
        text: 'One more thing about setup: accept the mess. Maker activities are inherently messy. If cleanliness is your top priority, creativity will suffer. Find a space where mess is okay — a garage, a porch, a dedicated corner with a tarp — and let it be the chaos zone. Clean up together afterward, but during the making, let it be wild.',
      },
      {
        type: 'heading',
        level: 2,
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'paragraph',
        text: 'Most kids don\'t realize that "free" apps and services collect their data — browsing habits, location, contacts, preferences — and use it for advertising or sell it to third parties. Teaching kids that they are the product, not the customer, of most free digital services is a crucial insight. It doesn\'t mean they can\'t use these services. It means they use them with awareness.',
      },
      {
        type: 'heading',
        level: 3,
