...
export const productDescriptions: Record<string, ProductDescription> = {
  ...
  'future-ready-skills-map': {
    opening:
      'A comprehensive parent guide to the 10 skills that matter most for your child\'s future — from emotional intelligence and critical thinking to AI literacy and life skills. Not another activity pack — this is your roadmap for raising a capable, confident, future-ready human.',
    whatsIncluded: [
