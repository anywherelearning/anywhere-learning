...
const posts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'cta', text: 'Want more ways to learn through doing? Our free guide gives you 10 real-world activities your kids can try this week — low prep, no curriculum.', href: '/free-guide', label: 'Get the Free Guide' },
      { type: 'faq', items: [
...

  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'A co-op class. A tutor for the subject you hate teaching. An online course. A grandparent who takes the kids for two hours. Activity packs that are genuinely [low prep](/blog/what-no-prep-means). You don\u2019t have to do everything yourself. That was never the deal.' },
  ...
  // ─── Post #6: What "No Prep" Actually Means ───
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Scroll through any homeschool marketplace and you\u2019ll see the same two words stamped on activity packs, printables, and lesson plans: "no prep." You download one, open it up, and the first page says: read this guide, gather these supplies, print on cardstock, laminate for durability. That\u2019s not no prep. That\u2019s moderate prep with good marketing.' },
      ...
      { type: 'list', ordered: false, items: [
        ...
        'Mid-morning: grab an activity card from a pack. It says "interview someone about their job." Your child calls grandpa and asks about his career. Time: 20 minutes. Prep: picking the card.',
  ...
  // ─── Post #26: Why "Just Let Them Play" ───
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Researchers have studied play for decades, and the findings are remarkably consistent. Psychologist [Peter Gray\'s 2023 commentary in the Journal of Pediatrics](https://www.sciencedaily.com/releases/2023/03/230309101330.htm) links the decades-long decline in independent play to the rising rates of anxiety and depression in children — and the [American Academy of Pediatrics\' 2018 "Power of Play" clinical report](https://publications.aap.org/pediatrics/article/142/3/e20182058/38649/The-Power-of-Play-A-Pediatric-Role-in-Enhancing) calls free play essential for building executive function, language, and social-emotional skills. Here\u2019s what\u2019s happening when your child is "just" playing:' },
      { type: 'list', ordered: false, items: [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'cta', text: 'Want to try real-world learning this week? Our free guide gives you 10 life skills activities your kids can start today — low prep, no curriculum.', href: '/free-guide', label: 'Get the Free Guide' },
      { type: 'faq', items: [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Here\'s the clearest comparison I can offer, based on our experience doing both, sometimes in the same week.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'What makes it sustainable: low prep, and kids retain more because they\'re doing real things in real contexts. It\'s also the hardest approach to burn out on — you can\'t burn out on something that\'s woven into daily life. This is [what "no prep" actually means](/blog/what-no-prep-means).' },
