...
const posts: BlogPost[] = [
...

  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'You started homeschooling because you wanted a better life for your family. If the way you\u2019re doing it is destroying you, [change the way you\u2019re doing it](/blog/new-to-homeschooling) — not whether you\u2019re doing it. The method is flexible. You are irreplaceable.' },
