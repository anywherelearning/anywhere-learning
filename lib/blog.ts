...
const posts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'The less stuff you carry, the better. We learned this the hard way after lugging a suitcase full of workbooks through three airports. Now we travel with printable activity cards, books, and whatever the kids need for their travel blog. Everything else, we find along the way.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'cta', text: 'Looking for meaningful learning activities that don\u2019t take up suitcase space? Our printable activity packs are designed for families on the move.', href: '/shop', label: 'Browse the Shop' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'cta', text: 'Want to turn everyday travel moments into real learning? Our printable activity guides are designed for families on the move \u2014 no prep needed.', href: '/shop', label: 'Browse the Shop' },
  ...
  // ─── Post 25: Nature-Based Learning Pillar Page ───
  {
    ...
    content: [
      ...
      { type: 'list', ordered: false, items: [
        ...
        'Seasonal scavenger hunts \u2014 printable challenges that work in any climate, any season',
