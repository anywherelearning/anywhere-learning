...
const posts: BlogPost[] = [
...

  {
    ...
    readTimeMinutes: 11,
    author: amelie,
    heroImageAlt: 'Child looking thoughtfully at a tablet screen with a parent beside them',
    pillarSlug: 'ai-digital-literacy',
    content: [
...

  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'You might be surprised at how quickly kids go from modifying existing games to creating their own. And once they start, good luck stopping them. My son has a stack of cardboard game prototypes that rivals our published game collection. Each one taught him something \u2014 about maths, about people, about the satisfaction of [making something that works](/resources/creativity-maker-activities).' },
...

  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'If your family loves [building and making things](/resources/creativity-maker-activities), a Rube Goldberg machine is the ultimate maker project. It\u2019s open-ended, endlessly customisable, and works with whatever you have on hand. No kit required. No instructions to follow. Just physics, creativity, and the stubborn belief that attempt 48 might be the one that works.' },
...

  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Land art and kinetic sculpture live at the intersection of two things we value deeply in our family: [nature-based learning](/resources/nature-based-learning) and [creative making](/resources/creativity-maker-activities). It\u2019s not just art and it\u2019s not just science. It\u2019s what happens when you slow down enough to really see the natural world and then respond to it with your hands.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'I\'ve been asked this question hundreds of times. At birthday parties. By my mother-in-law. By the woman behind me at the post office who overheard my kids talking about volcanoes at 10am on a Tuesday. The first few times, I stammered through it. Now? I have answers. And so will you.' },
      ...
      { type: 'pull-quote', text: 'The real world doesn\'t sort people by birth year. Homeschooled kids already live in the real world.', attribution: 'Amelie, Anywhere Learning' },
      ...
      { type: 'list', ordered: false, items: [
        'A mixed-age co-op meetup where my 5-year-old plays with 9-year-olds and my 8-year-old helps a 3-year-old',
        'Sports clubs, swim lessons, martial arts — with kids from every kind of schooling background',
  ...
  {
    slug: 'homeschool-road-trip',
    title: 'The Ultimate Guide to Homeschooling on Road Trips',
    excerpt: 'Road trips aren\'t a break from learning — they\'re one of the richest learning environments you\'ll ever create. Here\'s how to make the most of every mile.',
    category: 'travel-worldschool',
    publishedAt: '2025-10-28',
    dateModified: '2025-10-28',
    keywords: ['homeschool road trip', 'road trip learning', 'travel homeschool activities', 'learning while traveling', 'road trip educational activities'],
    readTimeMinutes: 10,
    author: amelie,
    heroImageAlt: 'Family packing a car for a road trip with kids looking at a map',
    content: [
      { type: 'summary', text: 'Road trips are one of the most natural and effective learning environments for homeschool families. Every mile covers geography, every stop is a field trip, and the unstructured time in between builds conversation, observation, and independent thinking skills that no worksheet can replicate.' },
      { type: 'paragraph', text: 'Our family has driven across three countries with kids in the back seat, and I can tell you: the road trip is the single most underrated homeschool tool. Not because I planned brilliant lessons for the car. Because the road itself is the lesson.' },
      { type: 'paragraph', text: 'Geography? You\'re driving through it. Maths? Every fuel stop, every distance calculation, every "how much longer?" question. History? Every town has a story. Science? Weather changes, ecosystems shift, and your kids notice all of it — if you let them.' },
      { type: 'heading', level: 2, text: 'Before you leave: the only prep you need' },
      { type: 'paragraph', text: 'I\'m not going to give you a 47-item packing checklist. That defeats the whole point. Here\'s what actually matters:' },
      { type: 'list', ordered: true, items: [
        'A paper map or atlas. Yes, even though you have GPS. Paper maps teach spatial reasoning, scale, and the relationship between places in a way a blue dot on a screen never will.',
        'A notebook per kid. For drawing, writing, listing, tallying — whatever they want.',
        'A few books. Audiobooks count. Stories set in the places you\'re driving through are gold.',
        'Snacks. Obviously.',
      ]},
      { type: 'paragraph', text: 'That\'s it. No laminated activity binders. No iPad loaded with educational apps. No colour-coded folders of worksheets organised by state. [No prep means no prep](/blog/what-no-prep-means).' },
      { type: 'heading', level: 2, text: 'Learning that happens naturally in the car' },
      { type: 'paragraph', text: 'Most parents stress about keeping kids "learning" during drive time. But learning is already happening. Here\'s what you\'re covering without trying:' },
      { type: 'heading', level: 3, text: 'Geography and navigation' },
      { type: 'paragraph', text: 'Give your child the map and make them the navigator. "How far is it to the next city? What river are we crossing? What state are we entering?" Even a 5-year-old can trace a route with their finger and tell you what comes next.' },
      { type: 'heading', level: 3, text: 'Maths everywhere' },
      { type: 'list', ordered: false, items: [
        '"We\'ve driven 180 miles and have 120 left. What fraction have we done?"',
        '"Fuel costs $3.45 per gallon and the tank takes 15 gallons. How much to fill up?"',
        '"If we\'re going 65 mph and it\'s 130 miles away, how long until we get there?"',
        'Tracking trip expenses and keeping a running total',
        'Reading road signs and doing mental arithmetic with speed limits and distances',
      ]},
      { type: 'heading', level: 3, text: 'Observation and science' },
      { type: 'paragraph', text: 'The landscape changes as you drive. Plains become hills become mountains. Oak trees become pines. Red soil becomes black soil. Ask your kids to notice it: "What\'s different about the land here compared to an hour ago?" That\'s geology, ecology, and geography — experienced, not read about.' },
      { type: 'pull-quote', text: 'A road trip doesn\'t interrupt your homeschool. It is your homeschool.', attribution: 'Amelie, Anywhere Learning' },
      { type: 'heading', level: 2, text: 'At every stop: the world is the classroom' },
      { type: 'paragraph', text: 'Every fuel stop, rest area, and small town is a field trip. Let your kids:' },
      { type: 'list', ordered: false, items: [
        'Read the historical markers (they\'re free history lessons)',
        'Talk to locals and ask questions about the area',
        'Explore a small-town general store and compare prices to home',
        'Find the local library (many have visitor passes — we\'ve visited libraries in 11 states)',
        'Visit a farmers\' market and learn what grows in this region',
        'Find the weird roadside attraction and let the kids research why it exists',
      ]},
      { type: 'paragraph', text: 'Some of our most memorable learning has come from unplanned stops. A fossil bed we stumbled on in Montana. A civil rights museum in a small town we\'d never heard of. A family-run orchard where the owner spent 30 minutes teaching my kids about grafting apple trees. None of this was on a lesson plan. All of it was unforgettable.' },
      { type: 'heading', level: 2, text: 'The long-drive toolkit: what actually works' },
      { type: 'paragraph', text: 'For the longer stretches where everyone needs something to do:' },
      { type: 'list', ordered: false, items: [
        'Audiobooks — especially stories set where you\'re driving. Listening to "Little House on the Prairie" while driving through South Dakota is a whole different experience.',
        'Car games with a learning twist — "20 Questions" builds logic, "License Plate Bingo" covers geography, "I Spy" sharpens observation',
        'Road trip journals — each kid writes or draws something from every day',
        'Podcast episodes about topics they\'re interested in',
        'Quiet independent reading time (no guilt about "just reading" — it\'s one of the most valuable things they can do)',
      ]},
      { type: 'tip', title: 'Multi-Age Tip', text: 'Give each child a different "job" for the trip. The oldest is the navigator (reads the map), the middle child is the journalist (records what they see), and the youngest is the collector (picks up interesting items at each stop — rocks, leaves, postcards). Everyone contributes, no one fights over the same role.' },
      { type: 'heading', level: 2, text: 'Screen time on road trips: a sane approach' },
      { type: 'paragraph', text: 'I\'m not going to tell you screens are evil on road trips. Sometimes you need two hours of peace to drive through Texas. Here\'s our approach: screens are for the boring stretches. Windows are for the interesting ones. When the landscape changes, the scenery is dramatic, or we\'re approaching a new place — screens go away. When it\'s flat highway for 200 miles and everyone is going stir-crazy — that\'s fine.' },
      { type: 'paragraph', text: 'The goal isn\'t screen-free perfection. It\'s [presence when it matters](/blog/slow-travel-over-bucket-list).' },
      { type: 'heading', level: 2, text: 'After the trip: making it stick' },
      { type: 'paragraph', text: 'When you get home, don\'t let the learning evaporate. A few simple things:' },
      { type: 'list', ordered: false, items: [
        'Have each kid share their favourite moment and why',
        'Put their road trip journals on the shelf as keepsakes',
        'Plot your route on a wall map and add pins',
        'Let the trip spark follow-up interests — if they loved the fossil bed, get books about paleontology',
      ]},
      { type: 'paragraph', text: 'The trip itself is just the beginning. The conversations, questions, and interests it sparks will feed your homeschool for weeks after you get home.' },
      { type: 'bundle-callout', slug: 'real-world-mega-bundle' },
      { type: 'cta', text: 'Planning your next family road trip? Our activity packs work anywhere — in the car, at a rest stop, or in a hotel room. No WiFi needed.', href: '/shop', label: 'Browse Activity Packs' },
      { type: 'faq', items: [
        { question: 'How do I homeschool on a road trip without losing my mind?', answer: 'Keep it simple. Bring a map, notebooks, and audiobooks. Let the trip itself be the curriculum — geography, maths, science, and history are built into every mile. Don\'t try to replicate your normal homeschool routine in a car.' },
        { question: 'What are the best road trip learning activities for kids?', answer: 'Map navigation, trip journaling, roadside history markers, mental maths with distances and fuel costs, audiobooks set in regions you\'re driving through, and observation games about changing landscapes. The best activities use the trip itself as the material.' },
        { question: 'How much screen time should I allow on a road trip?', answer: 'Use screens for the boring stretches and windows for the interesting ones. There\'s no magic number — it depends on your kids, the route, and your sanity. The goal is presence when the landscape or experience is worth attention.' },
        { question: 'Can a road trip count as homeschool hours?', answer: 'Absolutely. Geography, maths, science, reading, writing, history, and social studies are all naturally covered. Keep a simple log of activities and discussions if your state requires documentation.' },
        { question: 'What\'s the best age for educational road trips?', answer: 'Any age. Toddlers observe and absorb. Primary-age kids can navigate, journal, and ask questions. Older kids can plan routes, budget expenses, and research destinations. The trip adapts to wherever your children are developmentally.' },
      ]},
    ],
    relatedSlugs: ['homeschool-while-traveling', 'what-we-packed-worldschooling', 'slow-travel-over-bucket-list'],
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'pull-quote', text: '"Let\'s try it for one semester" got me further than two years of arguments ever did.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Our family homeschools most of the year with a loose structure at home. When we travel — whether it\'s a [road trip](/blog/homeschool-road-trip) or a few months abroad — we shift into worldschool mode. The maths workbook comes with us, but the daily schedule melts away and the location becomes the curriculum.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'The number one thing I hear from parents considering homeschooling is: "But I\'m not a teacher." Neither am I — anymore. I have a teaching degree collecting dust, and I can tell you: almost nothing I learned in teacher training applies to educating my own three kids at home. Different context, different relationship, different everything.' },
