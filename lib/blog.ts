...
const posts: BlogPost[] = [
  {
    ...
    hook: 'Doubling a recipe is fractions. Timing pasta is estimation. Dinner is already a lesson \u2014 you just haven\u2019t named it yet.',
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Here are five ways to lean into what\u2019s already happening in your kitchen, without turning it into a lesson that sucks the joy out of cooking together. Cooking is also one of the [10 life skills every kid should learn before they\u2019re 12](/blog/life-skills-before-12), so you\u2019re double-dipping every time you hand them the spatula.' },
      ...
      { type: 'paragraph', text: 'Try picking one ingredient per meal and tracing its journey. Kids love this game, and it naturally leads to conversations about seasons, climate, trade, and farming, the kind of rich, interconnected thinking that textbooks break into separate subjects. Pair it with a walk and you’ve set up a real-world science lesson on the spot, similar to how a [nature walk doubles as a science class](/blog/nature-walks-science).' },
      ...
      { type: 'paragraph', text: 'You don\u2019t need to add \u201ckitchen learning\u201d to your schedule. You just need to notice what\u2019s already there. Every time your kid measures flour, reads a recipe, or asks why onions make you cry, that\u2019s learning. Real, meaningful, lasting learning. The same principle scales up into longer [project-based learning at home](/blog/project-based-learning-homeschool) when a kitchen experiment turns into a week-long obsession.' },
  ...
  },
  {
    ...
    hook: 'A 30-minute walk covers gravity, erosion, ecosystems, and weather \u2014 no lesson plan required.',
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Every great scientist started by noticing things. Darwin noticed finches. Jane Goodall noticed chimpanzee behaviour no one had documented. Your kid notices that puddles disappear on hot days. That\u2019s evaporation. That\u2019s science. And it happened without you planning a thing.' },
      ...
      { type: 'paragraph', text: 'The Scandinavians have a saying: \u201cThere\u2019s no bad weather, only bad clothing.\u201d They\u2019re right. And the kids who grow up exploring in all conditions develop resilience that no indoor lesson can teach. When you want a more structured outing, try a [seasonal scavenger hunt](/blog/seasonal-scavenger-hunts) or layer in some [outdoor STEM challenges](/blog/outdoor-stem-challenges) that turn the same walk into a science lab.' },
...

  {
    ...
    hook: 'Hand a kid a list and watch their whole body become a sensor.',
    category: 'nature-learning',
  ...
  // ─── New audit P0 #1: Homeschool first-year checklist ───
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'This is a different kind of checklist. It’s the things future-you will be glad you did, organised by month, written by someone who is actually doing it (and has been homeschooled, taught in classrooms, and watched a lot of new homeschool families either soar or crash in their first 12 months).' },
