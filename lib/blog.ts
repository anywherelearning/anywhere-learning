...
const posts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: 'We\u2019re writing this from a beach in El Zonte. Our kids took surf lessons, learned to make pupusas, hiked volcanoes, and pay for everything in Bitcoin. Here\u2019s what worldschooling looks like when it\u2019s real \u2014 not Instagram.',
    category: 'travel-worldschool',
    ...
    content: [
      { type: 'paragraph', text: 'I\u2019m writing this from a hammock in El Zonte, El Salvador. The kids are somewhere between the beach and the tienda \u2014 I can hear them ordering something in Spanish. It\u2019s not perfect, but they\u2019re trying, and the lady at the counter is patient with them. That\u2019s more language practice than any app could give them.' },
      { type: 'paragraph', text: 'This is worldschooling. Not a Pinterest board. Not a curated Instagram grid of barefoot children reading Shakespeare on a mountaintop. Just our actual life \u2014 messy, sunburned, full of moments that teach more than any textbook ever could.' },
      ...
      { type: 'paragraph', text: 'We wake up whenever the heat wakes us. Breakfast is usually from a local comedor \u2014 the kids order in Spanish. They have to. Nobody in El Zonte is going to switch to English for them, and that\u2019s the whole point. We pay with Bitcoin and nobody bats an eye. That alone sparked a two-week conversation about cryptocurrency, digital wallets, and why an entire beach town decided to build its economy around it.' },
      { type: 'paragraph', text: 'Mornings are usually surf lessons. The kids are learning to read the ocean \u2014 when to paddle, how to spot a rip current, why waves break differently depending on the tide. That\u2019s physics, geography, and risk assessment, all wrapped up in something they\u2019d choose to do anyway.' },
      { type: 'paragraph', text: 'Afternoons are slower. Reading, journaling, drawing. Sometimes we pull out an activity pack. Sometimes we explore. Last week we took a pupusa-making class with a local family. The kids learned to mix the masa, fill and press the dough, and cook them on the plancha. They ate about twelve each. That was home economics, cultural studies, and the best lunch we\u2019ve had in months \u2014 all in one afternoon.' },
      ...
      { type: 'list', ordered: false, items: [
        'Monday: Spanish class in the morning, then the kids spent the afternoon at the convenience store practising what they\u2019d learned \u2014 buying fruit, asking prices, counting change in a new language.',
        'Tuesday: Hiked to a waterfall. Talked about erosion, rock formations, water cycles, and why the water was so cold despite the heat. The kids journaled about it that evening.',
        'Wednesday: Surf lessons and beach day. My oldest calculated wave intervals and tried to predict sets. My youngest made friends with a Salvadoran kid without sharing a common language. They played for three hours.',
        'Thursday: Visited a volcano. The drive alone was a geography lesson \u2014 elevation changes, cloud forests, coffee plantations on volcanic soil. At the crater, the kids asked questions I couldn\u2019t answer, so we looked them up together.',
        'Friday: Explored the new San Salvador library and the presidential palace. Architecture, history, government, the role of public institutions. My son wanted to know why some countries have presidents and some have prime ministers. That became the evening\u2019s conversation.',
      ...
      { type: 'paragraph', text: 'During our pupusa-making class, my son asked the owner how many pupusas she makes in a day. She said about 200. He pulled out his journal and started calculating: 200 pupusas \u00d7 $0.50 each = $100/day. Then he asked how much the ingredients cost. Then he figured out her profit margin. Then he asked if weekends were busier. This kid has never sat through a business studies class in his life.' },
      { type: 'paragraph', text: 'Or the Spanish classes \u2014 we signed them up for formal lessons three mornings a week. But the real language learning happens outside. At the tienda, at restaurants, asking surf instructors about the waves, chatting with other kids at the beach. The classroom gives them the grammar. The street gives them the confidence. You need both, and worldschooling gives you both.' },
      { type: 'paragraph', text: 'That\u2019s the thing about worldschooling \u2014 you can\u2019t plan for a pupusa-stand economics lesson or a volcano-hike geology class. You can only create the conditions where it\u2019s possible. And those conditions are surprisingly simple: slow down, stay curious, and let your kids talk to people.' },
      ...
      { type: 'paragraph', text: 'The guilt hits hardest when I see other homeschool families posting their curriculum checklists and standardised test scores. But then I watch my kid order lunch in Spanish, calculate a tip in Bitcoin, and explain to me how volcanoes form \u2014 all in the same day \u2014 and I think: no test measures this. But this is what actually matters.' },
      ...
      { type: 'heading', level: 2, text: 'What worldschooling teaches that school can\u2019t' },
      { type: 'list', ordered: false, items: [
        'Adaptability \u2014 new country, new language, new food, new routines. They learn to be comfortable with discomfort.',
        'Cultural awareness \u2014 not from a chapter in a textbook, but from making pupusas with a Salvadoran family and hearing their story.',
        'Resourcefulness \u2014 when you can\u2019t just Google everything or run to a familiar shop, kids learn to solve problems with what\u2019s available.',
        'Real communication \u2014 ordering food in Spanish, chatting with surf instructors, making friends without a shared language. These are skills no classroom can replicate.',
      ...
      { type: 'paragraph', text: 'I want to be clear about something: worldschooling isn\u2019t about the passport stamps. It\u2019s a mindset. It\u2019s the belief that the world \u2014 your town, your neighbourhood, your kitchen \u2014 is the best classroom your kids will ever have.' },
      ...
      { type: 'paragraph', text: 'My daughter just came back from the tienda. She ordered in Spanish, paid in Bitcoin from her own wallet, and is now sharing mango with her brother on the beach. Nobody assigned that. Nobody graded it. But I\u2019d put that against any classroom lesson, any day of the week.' },
      ...
      { type: 'faq', items: [
        ...
        { question: 'How do worldschooling families handle socialisation?', answer: 'Worldschooled kids interact with people of all ages and backgrounds daily \u2014 locals, other traveling families, shop owners, surf instructors. They develop social skills through real interaction, not just with same-age peers in a classroom. Many families also connect through worldschooling communities online and at meetups around the world.' },
