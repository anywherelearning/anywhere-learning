...
const posts: BlogPost[] = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'It\u2019s writing practice. It\u2019s reflection. It\u2019s a record they\u2019ll treasure for years. Some days it\u2019s a full research piece about hurricanes. Some days it\u2019s a quick sketch of a sea turtle. Both count.' },
  ...
  },
  {
    ...
    hook: 'Kids can ace a test on fractions and still not know how to halve a recipe. That\u2019s the gap real-world learning fills.',
    category: 'real-world-skills',
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Since starting this journey with my own kids, and creating activity guides to help other families do the same, I\u2019ve found that real-world learning falls into five natural categories. Most everyday activities touch several of them at once.' },
      ...
      { type: 'bundle-callout', slug: 'real-world-mega-bundle', pinned: true },
      { type: 'cta', text: 'Want to try real-world learning this week? Our free guide gives you real-world activities your kids can start today. No curriculum, low prep.', href: '/free-guide', label: 'Get the Free Guide' },
      { type: 'faq', items: [
  ...
  },
  {
    ...
    content: [
      { type: 'summary', text: 'Homeschool socialization concerns are the most common criticism homeschool families face. Published research (including a 2013 Peabody Journal of Education review by Richard Medlin and ongoing work by the National Home Education Research Institute) consistently shows that homeschooled children develop strong social skills through community involvement, mixed-age interactions, and real-world experiences, with outcomes that match or exceed those of traditionally schooled peers in friendship quality, civic engagement, and emotional wellbeing.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'faq', items: [
        ...
        { question: 'Which homeschool method has the best outcomes?', answer: 'No single method has been shown to produce dramatically better outcomes than the others. The [National Home Education Research Institute\'s research summary](https://nheri.org/research-facts-on-homeschooling/) suggests that parental engagement and a supportive home environment matter more than the specific philosophy you follow. All three approaches can produce excellent outcomes when the parent is present, responsive, and consistent.' },
      ]},
    ],
  ...
  // ─── Screen Time Cluster #1: Flagship pillar ───
  {
    ...
    excerpt: 'No banning, no battles. Here\u2019s the honest screen time and phones approach we use with a 10- and 12-year-old \u2014 and why the real goal isn\u2019t less screen time, but kids who can regulate it themselves.',
    ...
    relatedSlugs: ['media-literacy-kids', 'ai-myths-facts-kids', 'what-kids-should-know-before-18'],
