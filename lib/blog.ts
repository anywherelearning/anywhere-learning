...
const posts: BlogPost[] = [
  ...
  // ─── Post #6: What "No Prep" Actually Means ───
  {
    ...
    excerpt: 'Every homeschool resource claims to be "no prep." Most still need you to read a manual, gather supplies, and print on cardstock. Here\u2019s why true no prep is mostly a myth — and why honest low prep is what actually saves your homeschool.',
    category: 'homeschool-journey',
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Every homeschool resource claims to be "no prep." You download it, open it up, and the first page says: read this guide, gather these supplies, print on cardstock, laminate for durability. That\u2019s not no prep. That\u2019s moderate prep with good marketing.' },
  ...
  // ─── Post #26: Why "Just Let Them Play" ───
  {
    ...
    content: [
      { type: 'summary', text: 'Play-based learning is the process by which children develop critical cognitive, social, and emotional skills through unstructured, self-directed play. Research consistently shows that free play builds problem-solving, creativity, negotiation, and resilience more effectively than formal instruction, especially for children under 12.' },
