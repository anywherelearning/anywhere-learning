...
const posts: BlogPost[] = [
  ...
  // ─── Post #45: 5 Stages of Deschooling ───
  {
    ...
    content: [
      ...
      { type: 'image', src: '/images/deschooling-vine.jpeg', alt: 'Zach swinging on a vine in the jungle — unstructured, kid-led exploration', caption: 'Stage 3 in action. No agenda, no assignment — just a vine and a kid who decided to climb it.' },
  ...
  // ─── Post #6: What "No Prep" Actually Means ───
  {
    ...
    readTimeMinutes: 7,
    author: amelie,
    heroImage: '/images/no-prep-hero.jpeg',
    heroImageAlt: 'Julia holding a corn snake while Zach reads a field guide — a spontaneous, no-prep learning moment',
    ...
    content: [
      ...
      { type: 'image', src: '/images/no-prep-baking.jpeg', alt: 'Zach and Julia rolling out dough and cutting shapes together at the kitchen counter', caption: 'Baking day. Fractions, chemistry, fine motor skills — no lesson plan required.' },
  ...
  // ─── Post #26: Why "Just Let Them Play" ───
  {
    ...
    content: [
      ...
      { type: 'image', src: '/images/play-beach-sunset.jpeg', alt: 'Julia with arms wide open on a beach at sunset — pure, unstructured joy', caption: 'No lesson plan. No learning objective. Just a beach and a kid who feels free.' },
  ...
  },
  {
    ...
    heroImageAlt: 'Zach and Julia in zipline helmets and harnesses, beaming with excitement before an adventure',
    ...
    content: [
      ...
      { type: 'image', src: '/images/socialization-painting.jpeg', alt: 'Zach and Julia painting rainbows together — learning alongside each other', caption: 'This is what homeschool socialization looks like. Kids working together, helping each other, no bell schedule required.' },
      ...
      { type: 'image', src: '/images/socialization-snorkeling.jpeg', alt: 'Julia snorkeling in crystal clear water with family — social learning happens everywhere', caption: 'Real-world social skills: snorkeling with family, navigating new places, making friends in every country.' },
  ...
  },
  {
    ...
    readTimeMinutes: 10,
    author: amelie,
    heroImage: '/images/unschooling-vs-homeschool-hero.jpeg',
    heroImageAlt: 'Family hiking a volcano trail in El Salvador with a second volcano visible in the distance',
    content: [
  ...
  },
  {
    ...
    readTimeMinutes: 11,
    author: amelie,
    heroImage: '/images/methods-compared-hero.jpeg',
    heroImageAlt: 'Zach and Julia cutting fruit together at the kitchen counter — hands-on learning in action',
    content: [
  ...
  },
  {
    ...
    heroImageAlt: 'Family exploring a dramatic canyon gorge — discovering different paths together',
    ...
    content: [
      ...
      { type: 'image', src: '/images/approaches-popcorn.jpeg', alt: 'Julia packaging popcorn bags with custom labels — her own small business in action', caption: 'Real-world learning, ranked #1: Julia\u2019s popcorn business taught her pricing, branding, and maths. No lesson plan involved.' },
