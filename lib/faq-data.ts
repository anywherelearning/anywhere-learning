...
export const coreFaqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Nope. These are standalone activities. Pick one when you have 15 minutes or spend a whole afternoon. There\u2019s no sequence, no lesson plan, no curriculum to follow.',
  },
  {
...
export const aboutFaqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'That\u2019s entirely up to your family. Some activities take 15 minutes, others fill a whole afternoon. There\u2019s no timer and no pressure \u2014 go at whatever pace feels right for your kids.',
  },
];
