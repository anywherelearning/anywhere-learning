...
function LeafIcon() {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      <path d="M11 20A7 7 0 014 13V5a8 8 0 018-2c8 0 8 8 8 8a7 7 0 01-7 7H11z" /><path d="M2 21c0-3 1.85-5.36 5.08-6" />
    </svg>
  );
}
...
export const categoryIcons: Record<BlogCategory, ReactNode> = {
  'ai-digital-literacy': <CpuIcon />,
  'creativity-maker': <PaletteIcon />,
  'future-ready-skills': <CheckCircleIcon />,
